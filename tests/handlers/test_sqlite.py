...
class TestInsertData:
    def test_insert_list_of_dicts(self, db):
        ...
        db.insert_data("ins", [{"id": 1, "name": "Alice"}, {"id": 2, "name": "Bob"}])
...
class TestUpsertData:
    def test_upsert_inserts_new_row(self, db):
        ...
        db.upsert_data("upsert_t", [{"id": 1, "val": "original"}], unique_key="id")
    ...
    def test_upsert_updates_on_conflict(self, db):
        db.create_table("upsert_t2", {"id": "INTEGER", "val": "TEXT"}, pkey="id")
    ...
    def test_upsert_dataframe(self, db):
        db.create_table("upsert_df", {"id": "INTEGER", "val": "TEXT"}, pkey="id")
